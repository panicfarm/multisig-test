...
mod tests {
    ...
    fn test_sighash_p2sh_multisig_2x2() {
        ...
        test_sighash_legacy_multisig(rawtx, 0, None);
    }
    ...
    fn test_sighash_p2sh_multisig_2x3() {
        ...
        test_sighash_legacy_multisig(rawtx, 3, None);
    }
    ...
    fn test_sighash_p2ms_multisig_2x3() {
        ...
        test_sighash_legacy_multisig(rawtx, 0, Some(&reftx_script_pubkey_bytes));
    }
    ...
    fn test_sighash_p2wsh_multisig(rawtx: &str, inp_idx: usize, value: u64) {
        ...
        //in an M of N multisig, the witness elements from 1 (0-based) to N-2 are sigantures (with sighash flags as the last byte)
    ...
    /// Decodes M of N multisig ScriptPubKey into a required signatures count M and a vector of pubkeys of length N
    ///
    /// # Arguments
    ///
